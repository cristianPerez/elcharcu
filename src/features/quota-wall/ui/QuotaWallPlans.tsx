    ...
    <div className="mt-6">
      ...
      <article className="mt-6 rounded-2xl border border-cocoa/10 bg-cream p-6 text-cocoa">
        ...
        <a
          ...
          className="mt-6 inline-flex w-full items-center justify-center rounded-full bg-brasa px-6 py-3 text-sm font-medium tracking-wide text-cocoa shadow-surface transition-shadow duration-200 hover:shadow-raised focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-terracota focus-visible:ring-offset-2 active:scale-[0.97]"
        >
          {proPlan.ctaLabel}
        </a>
