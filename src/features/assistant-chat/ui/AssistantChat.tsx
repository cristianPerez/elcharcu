      ...
      <div className="flex flex-col gap-6 empty:hidden" aria-live="polite">
        ...
        {isThinking ? (
          <div className="flex items-center gap-1.5" aria-label="Pensando">
            <span className="h-2 w-2 animate-pulse rounded-full bg-brasa-dark [animation-delay:0ms]" />
            <span className="h-2 w-2 animate-pulse rounded-full bg-brasa-dark [animation-delay:160ms]" />
            <span className="h-2 w-2 animate-pulse rounded-full bg-brasa-dark [animation-delay:320ms]" />
          </div>
        ) : null}
      </div>
