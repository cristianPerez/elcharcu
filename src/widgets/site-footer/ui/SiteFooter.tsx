      ...
      <Container className="py-16">
        <div className="grid gap-10 md:grid-cols-[1.5fr_1fr_1fr]">
          ...
          <nav aria-label="Explorar">
            <h2 className="text-xs uppercase tracking-eyebrow text-cream/40">Explorar</h2>
          ...
          <nav aria-label="Pedidos">
            <h2 className="text-xs uppercase tracking-eyebrow text-cream/40">Pedidos</h2>
            <ul className="mt-4 space-y-3">
        ...
        <div className="mt-14 border-t border-cream/10 pt-6 text-center text-xs text-cream/40">
